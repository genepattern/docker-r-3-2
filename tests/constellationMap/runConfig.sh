...
COMMAND_LINE="Rscript $TASKLIB/run_ConstellationMap.R  $TASKLIB/  $TASKLIB/  $TASKLIB/   java   --input.gct.file=$INPUT_FILE_DIRECTORIES/GSE27473_series_matrix_collapsed_to_symbols.PROJ.gct --input.cls.file=$INPUT_FILE_DIRECTORIES/WT_vs_Knockdown.cls --gene.sets.database=c2.all.v5.1.symbols.gmt  --top.n=100  --direction=positive  --image.format=PDF  --jaccard.threshold=0.1 "
